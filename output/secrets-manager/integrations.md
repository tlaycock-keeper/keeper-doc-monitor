...
manager/integrations?fallback=true)[Keeper Connection
Manager](https://docs.keeper.io/en/keeper-connection-manager/secrets-
manager/integrations?fallback=true)[User
Guides](https://docs.keeper.io/en/user-guides/secrets-
manager/integrations?fallback=true)[Release
Notes](https://docs.keeper.io/en/release-notes/secrets-
manager/integrations?fallback=true)[Enterprise
Guide](https://docs.keeper.io/en/enterprise-guide/secrets-
manager/integrations?fallback=true)[MSP Guide](https://docs.keeper.io/en/msp-
guide/secrets-manager/integrations?fallback=true)[SSO Connect
Cloud](https://docs.keeper.io/en/sso-connect-cloud/secrets-
manager/integrations?fallback=true)[KeeperPAM and Secrets
Manager](https://docs.keeper.io/en/keeperpam/secrets-
manager/integrations?fallback=true)[SSO Connect On-
Prem](https://docs.keeper.io/en/sso-connect-on-prem/secrets-
manager/integrations?fallback=true)[Keeper
Bridge](https://docs.keeper.io/en/keeper-bridge/secrets-
manager/integrations?fallback=true)
...
Securely retrieve secrets from the Keeper Vault and use them in Azure DevOps
...
Use Keeper Secrets Manager in a CLI environment. Build scripts that securely
utilize your secrets, or easily access Secrets Manager functionality from your
terminal.
...
x-
prod.appspot.com%2Fo%2Fspaces%252F-MJXOXEifAmpyvNVL1to%252Fuploads%252F4Krnrd9YV0hxZH768DDY%252FScreen%2520Shot%25202022-04-18%2520at%25207.19.46%2520PM.png%3Falt%3Dmedia%26token%3Df6f385db-4bdc-47dd-a126-26c774690edd&width=768&dpr=4&quality=100&sign=32c4904f&sv=2)
