...
writer-image?fallback=true)[Keeper Connection
Manager](https://docs.keeper.io/en/keeper-connection-manager/secrets-
manager/integrations/docker-writer-image?fallback=true)[User
Guides](https://docs.keeper.io/en/user-guides/secrets-
manager/integrations/docker-writer-image?fallback=true)[Release
Notes](https://docs.keeper.io/en/release-notes/secrets-
manager/integrations/docker-writer-image?fallback=true)[Enterprise
Guide](https://docs.keeper.io/en/enterprise-guide/secrets-
manager/integrations/docker-writer-image?fallback=true)[MSP
Guide](https://docs.keeper.io/en/msp-guide/secrets-
manager/integrations/docker-writer-image?fallback=true)[SSO Connect
Cloud](https://docs.keeper.io/en/sso-connect-cloud/secrets-
manager/integrations/docker-writer-image?fallback=true)[KeeperPAM and Secrets
Manager](https://docs.keeper.io/en/keeperpam/secrets-
manager/integrations/docker-writer-image?fallback=true)[SSO Connect On-
Prem](https://docs.keeper.io/en/sso-connect-on-prem/secrets-
manager/integrations/docker-writer-image?fallback=true)[Keeper
Bridge](https://docs.keeper.io/en/keeper-bridge/secrets-
manager/integrations/docker-writer-image?fallback=true)
...
The Docker Writer Image for KSM is an image that can download secret files and
also generate a file containing secrets.
...
The parameters are handled by passing environment variables into the
container.
...
The format of the file is based on the value of `SECRETS_FILE_TYPE`. The type
...
The types related to a shell can be sourced to place the secrets into the
environment.
...
The Docker Writer Image for KSM can be used for many applications. Here are
some examples.
