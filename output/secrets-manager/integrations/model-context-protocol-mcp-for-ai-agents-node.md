...
[Export as
PDF](/en/keeperpam/~gitbook/pdf?page=lfFziFdDSrS7Fbr2LCgR&only=yes&limit=100)
...
(Docker)](/en/keeperpam/secrets-manager/integrations/model-context-protocol-
...
The server will use this token to generate and save a configuration file
automatically.
...
Add to your Claude Desktop configuration (`~/Library/Application
...
The server communicates via stdio, so you can integrate it with any MCP-
compatible client by running:
...
Retrieve a complete secret by UID or title (sensitive fields masked by
default)
...
Create a new folder (requires confirmation; must specify a parent shared
folder)
...
<https://github.com/Keeper-Security/keeper-mcp-
node/>[](https://github.com/Keeper-Security/keeper-mcp-node/)

[GitHub - Keeper-Security/keeper-mcp-node: MCP implementation using Keeper
Secrets Manager and NodeGitHub](https://github.com/Keeper-Security/keeper-mcp-
node/)
...
x-
prod.appspot.com%2Fo%2Fspaces%252F-MJXOXEifAmpyvNVL1to%252Fuploads%252FEOPQ8h0TMi0HwSY7bbC9%252Fimage.png%3Falt%3Dmedia%26token%3D385e7a3b-388a-4ef4-8078-e6134f61ce7e&width=768&dpr=4&quality=100&sign=3cccddba&sv=2)
