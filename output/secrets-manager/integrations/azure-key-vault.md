...
manager/integrations/azure-key-vault?fallback=true)[User
Guides](https://docs.keeper.io/en/user-guides/secrets-
manager/integrations/azure-key-vault?fallback=true)[Release
Notes](https://docs.keeper.io/en/release-notes/secrets-
manager/integrations/azure-key-vault?fallback=true)[Enterprise
Guide](https://docs.keeper.io/en/enterprise-guide/secrets-
manager/integrations/azure-key-vault?fallback=true)[MSP
Guide](https://docs.keeper.io/en/msp-guide/secrets-manager/integrations/azure-
key-vault?fallback=true)[SSO Connect Cloud](https://docs.keeper.io/en/sso-
connect-cloud/secrets-manager/integrations/azure-key-
vault?fallback=true)[KeeperPAM and Secrets
Manager](https://docs.keeper.io/en/keeperpam/secrets-
manager/integrations/azure-key-vault?fallback=true)[SSO Connect On-
Prem](https://docs.keeper.io/en/sso-connect-on-prem/secrets-
manager/integrations/azure-key-vault?fallback=true)[Keeper
Bridge](https://docs.keeper.io/en/keeper-bridge/secrets-
manager/integrations/azure-key-vault?fallback=true)
...
The KSM CLI needs the credentials for the Azure account to set secrets. These
...
type for each required Azure field. Click "Edit Label" to change the labels to
...
that will be made to your Azure Key Vault values without actually pushing the
