...
[Docs Home](https://docs.keeper.io/en/privilege-manager/managing-
requests?fallback=true)[Keeper Connection
Manager](https://docs.keeper.io/en/keeper-connection-manager/privilege-
manager/managing-requests?fallback=true)[User
Guides](https://docs.keeper.io/en/user-guides/privilege-manager/managing-
requests?fallback=true)[Release Notes](https://docs.keeper.io/en/release-
notes/privilege-manager/managing-requests?fallback=true)[Enterprise
Guide](https://docs.keeper.io/en/enterprise-guide/privilege-manager/managing-
requests?fallback=true)[MSP Guide](https://docs.keeper.io/en/msp-
guide/privilege-manager/managing-requests?fallback=true)[SSO Connect
Cloud](https://docs.keeper.io/en/sso-connect-cloud/privilege-manager/managing-
requests?fallback=true)[KeeperPAM and Secrets
Manager](https://docs.keeper.io/en/keeperpam/privilege-manager/managing-
requests?fallback=true)[SSO Connect On-Prem](https://docs.keeper.io/en/sso-
connect-on-prem/privilege-manager/managing-requests?fallback=true)[Keeper
Bridge](https://docs.keeper.io/en/keeper-bridge/privilege-manager/managing-
requests?fallback=true)
...
To manage elevation requests:
  ...
  2. Navigate to **Privilege Manager > Requests** tab
