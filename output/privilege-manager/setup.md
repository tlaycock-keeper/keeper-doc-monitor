...
manager/setup?fallback=true)[User Guides](https://docs.keeper.io/en/user-
guides/privilege-manager/setup?fallback=true)[Release
Notes](https://docs.keeper.io/en/release-notes/privilege-
manager/setup?fallback=true)[Enterprise
...
guide/privilege-manager/setup?fallback=true)[SSO Connect
...
bridge/privilege-manager/setup?fallback=true)
...
Follow the below steps to start using Keeper Privilege Manager.
...
With Privilege Manager, an admin role is required with permissions covering
end-user privilege.
