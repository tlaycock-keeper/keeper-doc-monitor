...
In the below example, we'll re-generate a password in the vault on a daily
basis.
...
To confirm that persistent login is working, execute Commander again and it
will automatically login to the shell.
...
In this particular example, the password will rotate from the Keeper vault and
