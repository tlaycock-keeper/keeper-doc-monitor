...
[Export as
PDF](/en/keeperpam/~gitbook/pdf?page=b83i3sPmGLJG0ldNSxfz&only=yes&limit=100)
...
KeeperPAM supports automated password rotation for various SaaS applications
and services. This feature allows you to automatically update passwords across
multiple systems whenever a user's password is rotated, ensuring synchronized
...
SaaS configurations are stored as Login records with custom fields that define
...
The command will prompt you for the required configuration values specific to
your chosen SaaS type.

**Manual Configuration**

You can also create a Login record manually and add the appropriate custom
fields:
...
This will display all configured SaaS rotations for the specified user,
including their current settings.
...
Control whether a SaaS rotation is active by setting the `Active` custom
field:
...
In addition to built-in integrations, you can use custom plugins for
...
Some plugins may need access to your PAM configuration credentials (e.g., for
AWS or Azure integration). Grant access by adding the plugin name to the allow
list:
...
If you need a plugin for a service not currently available, you can develop
your own using the development environment provided in the repository. The
repository includes:
...
x-
prod.appspot.com%2Fo%2Fspaces%252F-MJXOXEifAmpyvNVL1to%252Fuploads%252FVigI4XWYFOUI8Jxor8Uc%252Fimage%2520%282%29.png%3Falt%3Dmedia%26token%3Dc939fde1-399b-4857-85e7-b9e3a8173912&width=768&dpr=4&quality=100&sign=c15c2c3d&sv=2)
