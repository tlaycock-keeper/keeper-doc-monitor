...
network/database/mongodb?fallback=true)[Keeper Connection
...
Keeper Rotation will use the credentials linked from the **PAM Database**
record to rotate the **PAM User** records on your local environment. The **PAM
User** credential needs to be in a shared folder that is shared to the KSM
