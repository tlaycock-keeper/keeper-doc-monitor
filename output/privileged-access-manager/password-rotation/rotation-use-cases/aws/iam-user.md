...
rotation/rotation-use-cases/aws/iam-user?fallback=true)[Keeper Connection
Manager](https://docs.keeper.io/en/keeper-connection-manager/privileged-
access-manager/password-rotation/rotation-use-cases/aws/iam-
user?fallback=true)[User Guides](https://docs.keeper.io/en/user-
guides/privileged-access-manager/password-rotation/rotation-use-cases/aws/iam-
...
guide/privileged-access-manager/password-rotation/rotation-use-cases/aws/iam-
...
manager/password-rotation/rotation-use-cases/aws/iam-user?fallback=true)[SSO
Connect On-Prem](https://docs.keeper.io/en/sso-connect-on-prem/privileged-
access-manager/password-rotation/rotation-use-cases/aws/iam-
user?fallback=true)[Keeper Bridge](https://docs.keeper.io/en/keeper-
bridge/privileged-access-manager/password-rotation/rotation-use-cases/aws/iam-
user?fallback=true)
...
In this guide, you will learn how to rotate passwords for AWS IAM users. In
Keeper, the **PAM Configuration** contains all of the information needed to
rotate passwords. The record containing the AWS IAM user accounts to be
rotated are stored in the **PAM User** record.
...
Keeper Rotation uses the AWS API to rotate the PAM User records in your AWS
environment. The PAM User records need to be in a shared folder that is shared
to the KSM application created in the prerequisites.
...
A unique ID for this instance of AWS. This is only for your reference and can
be anything, but its recommended to be kept short Ex: `AWS-DepartmentName`
