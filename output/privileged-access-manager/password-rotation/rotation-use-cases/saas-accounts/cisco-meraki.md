...
rotation/rotation-use-cases/saas-accounts/cisco-ios-xe)[NextService
...
Step 2: Add PAM Script
  ...
  * Attach the below [Python script ](/en/keeperpam/privileged-access-manager/password-rotation/rotation-use-cases/saas-accounts/cisco-meraki#python-script)that will perform the password rotation. The script has additional comments inside that describe each line.
