...
started/gateways/advanced-configuration/gateway-configuration-with-custom-
fields?fallback=true)[Keeper Connection
...
configuration-with-custom-fields?fallback=true)[User
