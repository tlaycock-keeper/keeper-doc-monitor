...
This is the PAM Configuration that defines the environment and Gateway being
utilized.
...
When enabled, the keyboard events will also be monitored and played back
alongside the graphical session recording.
...
If set, the Chromium browser will ignore an invalid certificate as long as the
URL matches the exact domain that is set in the Record URL field.
...
page. Multiple patterns may be specified, separated by newlines.
...
may be specified, separated by newlines.
