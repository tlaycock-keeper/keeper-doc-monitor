...
manager/references/importing-pam-records?fallback=true)[Keeper Connection
Manager](https://docs.keeper.io/en/keeper-connection-manager/privileged-
access-manager/references/importing-pam-records?fallback=true)[User
Guides](https://docs.keeper.io/en/user-guides/privileged-access-
manager/references/importing-pam-records?fallback=true)[Release
Notes](https://docs.keeper.io/en/release-notes/privileged-access-
manager/references/importing-pam-records?fallback=true)[Enterprise
Guide](https://docs.keeper.io/en/enterprise-guide/privileged-access-
manager/references/importing-pam-records?fallback=true)[MSP
Guide](https://docs.keeper.io/en/msp-guide/privileged-access-
manager/references/importing-pam-records?fallback=true)[SSO Connect
Cloud](https://docs.keeper.io/en/sso-connect-cloud/privileged-access-
manager/references/importing-pam-records?fallback=true)[KeeperPAM and Secrets
Manager](https://docs.keeper.io/en/keeperpam/privileged-access-
manager/references/importing-pam-records?fallback=true)[SSO Connect On-
Prem](https://docs.keeper.io/en/sso-connect-on-prem/privileged-access-
manager/references/importing-pam-records?fallback=true)[Keeper
Bridge](https://docs.keeper.io/en/keeper-bridge/privileged-access-
manager/references/importing-pam-records?fallback=true)
...
[Export as
PDF](/en/keeperpam/~gitbook/pdf?page=hWK83AltPZDqj3h7g0o6&only=yes&limit=100)
...
Below is an example template in JSON format which imports 2 PAM Machine
records, 2 PAM User records and adds then to a shared folder called "My Shared
Folder".
