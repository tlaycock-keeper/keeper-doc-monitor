...
KeeperPAM enables zero-trust privileged session management for SQL Server
databases through an interactive CLI. This guide shows how to configure SQL
Server connections on your PAM Database Records in the Keeper Vault. Sessions
are securely initiated from the Vault, routed via the Keeper Gateway, and
...
populated based on the selected protocol. In this guide, the SQL Server
...
will override the default port. For SQL Server, the port is 1433
