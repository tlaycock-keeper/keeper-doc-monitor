...
manager/connections/examples/postgresql-protocol-postgresql-
...
guides/privileged-access-manager/connections/examples/postgresql-protocol-
postgresql-database?fallback=true)[Release
...
guide/privileged-access-manager/connections/examples/postgresql-protocol-
postgresql-database?fallback=true)[SSO Connect
...
connect-on-prem/privileged-access-manager/connections/examples/postgresql-
protocol-postgresql-database?fallback=true)[Keeper
...
In this guide, you will learn how to configure a PostgreSQL Database on your
**PAM Database** and configure the **PostgreSQL protocol** to successfully
launch a zero-trust connection to the PostgreSQL Database — directly from your
Keeper Vault.
...
After completing the above, you can launch zero-trust connections to the
PostgreSQL Database directly from your Keeper Vault.
...
After setting up your Gateway and PAM Configuration Record, the PostgreSQL
...
Once you have configured the PostgreSQL Protocol connection on your PAM
