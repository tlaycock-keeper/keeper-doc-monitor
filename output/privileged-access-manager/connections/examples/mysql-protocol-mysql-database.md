...
guides/privileged-access-manager/connections/examples/mysql-protocol-mysql-
database?fallback=true)[Release Notes](https://docs.keeper.io/en/release-
notes/privileged-access-manager/connections/examples/mysql-protocol-mysql-
database?fallback=true)[Enterprise
Guide](https://docs.keeper.io/en/enterprise-guide/privileged-access-
manager/connections/examples/mysql-protocol-mysql-database?fallback=true)[MSP
Guide](https://docs.keeper.io/en/msp-guide/privileged-access-
manager/connections/examples/mysql-protocol-mysql-database?fallback=true)[SSO
...
access-manager/connections/examples/mysql-protocol-mysql-
database?fallback=true)[Keeper Bridge](https://docs.keeper.io/en/keeper-
bridge/privileged-access-manager/connections/examples/mysql-protocol-mysql-
...
In this guide, you will learn how to configure a MySQL Database on your **PAM
Database** and configure the **MySQL protocol** to successfully launch a zero-
trust connection to the MySQL Database — directly from your Keeper Vault.
