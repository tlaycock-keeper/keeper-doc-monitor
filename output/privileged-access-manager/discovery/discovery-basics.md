...
manager/discovery/discovery-basics?fallback=true)[Keeper Connection
Manager](https://docs.keeper.io/en/keeper-connection-manager/privileged-
access-manager/discovery/discovery-basics?fallback=true)[User
Guides](https://docs.keeper.io/en/user-guides/privileged-access-
manager/discovery/discovery-basics?fallback=true)[Release
Notes](https://docs.keeper.io/en/release-notes/privileged-access-
manager/discovery/discovery-basics?fallback=true)[Enterprise
Guide](https://docs.keeper.io/en/enterprise-guide/privileged-access-
manager/discovery/discovery-basics?fallback=true)[MSP
Guide](https://docs.keeper.io/en/msp-guide/privileged-access-
manager/discovery/discovery-basics?fallback=true)[SSO Connect
Cloud](https://docs.keeper.io/en/sso-connect-cloud/privileged-access-
manager/discovery/discovery-basics?fallback=true)[KeeperPAM and Secrets
Manager](https://docs.keeper.io/en/keeperpam/privileged-access-
manager/discovery/discovery-basics?fallback=true)[SSO Connect On-
Prem](https://docs.keeper.io/en/sso-connect-on-prem/privileged-access-
manager/discovery/discovery-basics?fallback=true)[Keeper
Bridge](https://docs.keeper.io/en/keeper-bridge/privileged-access-
manager/discovery/discovery-basics?fallback=true)
...
infrastructure using Discovery.
...
AWS discovery makes use of whatever AWS Role Policies have been granted to the
Keeper Gateway in order to discover resources. The PAM Configuration filters
against the provided region names to limit the findings.

In order for the Keeper Gateway to discover an AWS resource, it must be able
...
security groups as necessary to allow this.
