...
Keeper Secrets Manager is a Zero Knowledge platform. Encryption and decryption
of secrets takes place locally on the Client Device running the `ksm`
...
Unique Client Device Identifier (HMAC_SHA512 hash of the One Time Access
Token)
